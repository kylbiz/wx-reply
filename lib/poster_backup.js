...
// Poster.prototype.uploadMedia = function(options, callback) {
// 	log("uploadMedia: I am called.");
// 	if(!options
// 		|| !options.hasOwnProperty("imagePath")
// 		|| !options.hasOwnProperty("type")) {

// 		log("uploadMedia: options illegal", options);
// 		callback("uploadMedia: options illegal", null);
// 	} else {
// 		var imagePath = options.imagePath;
// 		var type = options.type;

// 		api.uploadMedia(imagePath, type, function(err, result) {
// 			if(err) {
// 				log("uploadMedia: upload image error", err);
// 				callback(err, null);
// 			} else {
// 				log("uploadMedia: upload image succeed");

// 				var media_id = result.media_id;
// 				callback(null, { media_id: media_id});
// 			}
// 		});			
// 	}
// }
