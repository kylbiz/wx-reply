	    	...
	    	api.getUser({openid: FromUserName, lang: 'en'}, function(err, user) {
	    		if(err) {
	    			...
	    			if(!user || !user.hasOwnProperty("nickname")) {
	    				...
	    				self.poster.getWxUserImg(wxImgOptions, function(err, imgInfo) {
	    					if(err) {
	    						...
	    						self.poster.fillWord(fillWordOptions, function(err, image) {
	    							if(err) {
	    								...
	    								self.poster.handlePhoto(handlePhotoOptions, function(err) {
	    									if(err) {
