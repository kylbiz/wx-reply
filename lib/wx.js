	...
	if(!options
		...
		client.get(userURI, function(err, req, res, obj) {
			if(err) {
				...
				log("getUserInfo: get user info succeed.", obj);

				if(obj.hasOwnProperty("openid")){
					callback(null, {user: obj});		
				} else if(obj.hasOwnProperty("errcode") && (obj.errcode === "40001") || obj.errcode === "42001" || obj.errcode === "40014" || obj.errcode === "41001"){
